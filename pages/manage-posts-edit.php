...
?>
  ...
  <section class="Manage-posts-edit">
      ...
      <?php require dirname( __DIR__ ) . '/parts/error_box.php'; ?>
        <form method="POST" action="<?php echo $_SERVER['REQUEST_URI']; ?>" >
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="assignment-image-url" name="image_url" value="<?php echo $post->image_url ?>" />
          </div>
          <div class="mb-3">
            <label for="assignment-video-url" class="form-label">Video URL</label>
            <input type="text" class="form-control" id="post-video-url" name="video_url" value="<?php echo $post->video_url ?>" />
          </div>
          <div class="mb-3">
